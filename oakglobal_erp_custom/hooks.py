...
fixtures = [
    ...
    {"doctype": "Report", "filters": [["name", "in", ["Employee Request Center", "Manager Approval Dashboard", "Team Attendance Summary", "Team Leave Calendar", "Pending Approval Items", "Payroll Preflight Summary", "Payroll Cost Dashboard"]]]},
